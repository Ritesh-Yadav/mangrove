...
INVALID_LATITUDE_GPS = {ENTITY_TYPE: "clinic",
                        ...
                        ERROR_MSG: "GPS Incorrect GPS format. The GPS coordinates must be in the following format: xx.xxxx yy.yyyy. Example -18.8665 47.5315Mobile Number Please enter a valid phone number.Only numbers and -(dash) allowed"}
