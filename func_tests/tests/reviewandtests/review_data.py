...
VALID_DATA = {PROJECT_PROFILE: {PROJECT_NAME: "clinic5 test project",
              ...
              DATA_SENDER_COUNT: "3",
              QUESTIONNAIRE: [u"What is associatéd entity?", u"What is your namé?", u"What is age öf father?", u"What is réporting date?", "What is your blood group?", u"What aré symptoms?", u"What is the GPS codé for clinic"],
              REMINDERS: "disabled"
              }
