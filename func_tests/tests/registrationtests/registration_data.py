...
EXISTING_EMAIL_ADDRESS_ERROR_MESSAGE = u"Office Phone Number Please enter a valid phone number* Email address This email address is already in use. Please supply a different email address.Office Phone Please enter a valid phone numberMobile Phone Please enter a valid phone number"
...
INVALID_EMAIL_FORMAT_ERROR_MESSAGE = u"Office Phone Number Please enter a valid phone number* Email address Enter a valid email address. Example:name@organization.comOffice Phone Please enter a valid phone numberMobile Phone Please enter a valid phone number"
...
INVALID_WEBSITE_URL_ERROR_MESSAGE= u"Office Phone Number Please enter a valid phone numberWebsite Url Enter a valid URL.Office Phone Please enter a valid phone numberMobile Phone Please enter a valid phone number"
