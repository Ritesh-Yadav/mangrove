...
#        (r'^examples/$', TemplateView.as_view(template_name='home/examples.html')),
        (r'^examples/understand-who-benefits-from-services/$', TemplateView.as_view(template_name='home/examples1.html')),
        (r'^examples/track-teacher-attendance/$', TemplateView.as_view(template_name='home/examples2.html')),
        (r'^examples/send-services-and-aid-where-they-re-needed/$', TemplateView.as_view(template_name='home/examples3.html')),
